...
GLOBAL_DROPOUT = 0.2   ## 0.8     ##  0.8

##################################################################


class ResidualSIHead(nn.Module):
    def __init__(self, input_dim, dropout_rate=GLOBAL_DROPOUT):
        super().__init__()
...
class Head(nn.Module):
    ...
    def __init__(self, head_size, n_embd, block_size, dropout_rate=GLOBAL_DROPOUT):
        super().__init__()
...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, num_heads, head_size, n_embd, block_size, dropout_rate=GLOBAL_DROPOUT):    ## (8, 64)
        super().__init__()
...
class FeedForward(nn.Module):
    ...
    def __init__(self, n_embd, dropout_rate=GLOBAL_DROPOUT):         ## 512
...
class Time_Series_GPT(nn.Module):
    ...
    def __init__(self, params_obj, dropout_rate=GLOBAL_DROPOUT):
        ...
        self.num_features = params_obj.num_features     ## 35   28
        ...
        self.dropout_24_512 = nn.Dropout(dropout_rate)
