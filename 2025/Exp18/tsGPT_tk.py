...
class ParamsGPT:
    ...
    def __init__(self):
        ...
        self.batch_size        = 256  ## 1024  ## 64 ## 16 
        self.max_iters         = 100    ## 1000 ## 3000  ## 3000   ## 200  ## 5000   ## 100 worked fine 
    ...
    def random_4_runs( self ):
        self.index_to_slice    = 336
        self.training_chunk    = 500
        self.the_range = self.training_chunk + self.block_size
        ...
        chunk400to500_train = train_CIVS[ 400  :  ]
        chunk300to500_train = train_CIVS[ 300  :  ] 
        chunk200to500_train = train_CIVS[ 200  :  ]  
        chunk100to500_train = train_CIVS[ 100  :  ] 
        chunk000to500_train = train_CIVS[      :  ]
        return chunk400to500_train, chunk300to500_train, chunk200to500_train, chunk100to500_train, chunk000to500_train, test_CIVS
