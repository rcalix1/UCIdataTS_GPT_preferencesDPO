...
class inferenceGPT:
    ...
    def __init__(self):
        ...
        self.exclude_manual_x_train   = False                             ## step 9
    ...
    def print_first_few_R2_old(self, real_si_concat, pred_si_concat, THE_FIRST_FEW ):
    ...
    def time_series_metrics_old(self, y_true, y_pred, THE_FIRST_FEW ):
        """
        y_true: numpy array of shape (N,)
        y_pred: numpy array of shape (N,)
        """
    ...
    def dpo_finetune_with_kl(self, model, base_model, preference_data, optimizer=None, device="cuda", epochs=3, beta=0.05):
        ...
        if self.exclude_manual_x_train:
        ...
        for epoch in range(self.epochs_GRPO_kl):
            ...
            for item in preference_data:
                ...
                rej_score  = F.mse_loss(pred_new,  rejected_tensor[:, -9:, 2],  reduction='mean')  ## [:, -9:, :]
